<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuotLaunch.aspx.cs" Inherits="QuotLaunch" %>
...
<body>
    <form id="formQuotLaunch" runat="server" autocomplete="off" submitdisabledcontrols="True">
    ...
    <div id="infoPopup" style="display: none; max-width: 90%;" class="modal">
        <p>
            ...
            <div style="text-align: right">
                <input type="image" src="Contents/img/imprime.gif"
                    onclick="PrintFrame('ReportFrameReportViewer1')" /></div>
        </p>
        <hr />
        <div id="contenediv">
